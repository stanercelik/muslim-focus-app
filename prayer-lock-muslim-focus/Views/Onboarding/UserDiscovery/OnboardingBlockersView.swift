...
struct OnboardingBlockersView: View {
                        ...
                        ForEach(Blocker.allCases, id: \.self) { blocker in
                            BlockerOptionButton(
                                ...
                                action: {
                                    ...
                                    viewModel.toggleBlocker(blocker)
                                }
                            )
                        }
                    }
...
// MARK: - Blocker Option Button
struct BlockerOptionButton: View {
    let title: String
    let isSelected: Bool
    let isDisabled: Bool
    let action: () -> Void
...
#Preview {
    OnboardingBlockersView(viewModel: OnboardingViewModel())
}
